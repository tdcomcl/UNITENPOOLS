...
echo "Deteniendo procesos en el puerto 3011..."
# Buscar y detener procesos que usan el puerto 3011
lsof -ti:3011 | xargs kill -9 2>/dev/null || echo "No hay procesos usando el puerto 3011"
